function [sRegions] = ROIs2Regions_LQ(cvsROIs, vnImageSize)
...
if numel(cvsROIs) == 1 % changes by LQ to include the case when there is only one cvsROI
    sThisROI = cvsROIs;
    switch (lower(sThisROI.strType))
        case 'rectangle'
                ...
                sRegions.PixelIdxList = find(mbThisMask);
